...
document.querySelector('#taxPercent').addEventListener('keyup', () => updateAll());
document.querySelector('#discountPercent').addEventListener('keyup', () => updateAll());
document.querySelector('#shippingCharges').addEventListener('keyup', () => updateAll());
document.querySelector('#amountPaid').addEventListener('keyup', () => updateAll());